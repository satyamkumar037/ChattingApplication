...
public class Client implements ActionListener
{
    ...
    Client()
    {
       ...
       ImageIcon i3 = new ImageIcon(i2);
        ...
        JLabel name = new JLabel("Rupam Dom");
    ...
    public static void main(String Args[])
    {
        ...
        try
        {
            Socket s = new Socket("127.0.0.1" , 6001);//local host , port address
...
//readUTF ki help se humne data read kiya//
 //WriteUTF ki help se humne data write kiya
//isme humne socket programming use kiya hai 